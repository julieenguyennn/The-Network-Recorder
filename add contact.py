...
def add_contact():
    ...
    category = category_combobox.get()  # Get the selected category
    note = note_entry.get()
...
def open_calendar():
    ...
    def get_selected_date():
        ...
        last_met_entry.delete(0, END)
        last_met_entry.insert(0, selected_date)
        top.destroy()
...
Label(root, text="Last met:").grid(row=2, column=0, padx=5, pady=5)
...
calendar_icon = PhotoImage(file="/Users/junwei/Documents/INF452 Final Project/GUI graphics/calendar_icons.png")  # Replace "calendar_icon.png" with your image file
...
last_met_entry.grid(row=2, column=1, padx=5, pady=5)
